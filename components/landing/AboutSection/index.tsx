  ...
  return (
    <div className="relative z-10 flex h-full max-w-[80%] grow items-center justify-center">
      <div className="max-w-[70%]">
        <h2 className="my-10 text-xl font-bold">About Me</h2>
        <p className="">
          As a Full Stack developer, I love bringing ideas to life through the
          use of technology.
        </p>
        <p>
          Lately I've been delving into the realm of animations and using them
          to make websites more interactive and fun.
        </p>
